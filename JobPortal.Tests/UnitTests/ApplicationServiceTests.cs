...
namespace JobPortal.Tests.UnitTests
{
    ...
    public class ApplicationServiceTests : UnitTestsBase
    {
        ...
        public async Task GetApplicationById_Test()
        {
            ...
            Assert.AreEqual("asd", application.Name);
            Assert.AreEqual("Test", application.FullName);
            Assert.AreEqual("TestEmail", application.Email);
        }
        [Test]
        ...
        public async Task GetAllApplications_Test()
        {
            ...
            Assert.AreEqual(1, myApplicationsViewModel.Count);
